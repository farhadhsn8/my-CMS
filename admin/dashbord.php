                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span class="subject">
                                        <span class="from">سید فرهاد حسینی</span>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="" href="dashbord.php?m=product_cat&p=add">افزودن دسته جدید </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a class="" href="dashbord.php?m=news_cat&p=add">افزودن دسته جدید </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=contacts&p=list">لیست تماس ها</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=setting&p=edit">  ویرایش تنظیمات</a></li>
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <?php
                    ...
                    //add krdn file add mojud dar folder menu be in bakhsh

                    $m = $_GET['m'];
                    $p = $_GET['p'];
                    include_once "$m/$p.php"; // dashbord.php?m=menu&p=add
                ?>
            </section>
        </section>
        <!--main content end-->
